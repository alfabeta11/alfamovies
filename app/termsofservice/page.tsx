    ...
    <>
      ...
      <div className="my-4 lg:my-8 lg:text-justify lg:text-lg ">
        ...
        <p className="mb-4 mt-1 text-base text-slate-400">
          Welcome to Alfamovies! These terms and conditions govern your use of
          our website and services. Alfamovies is a platform designed to provide
          users with access to a wide range of movies hosted on third-party
          servers. By accessing or using Alfamovies, you agree to comply with
        ...
        <p className="mb-4 mt-1 text-base text-slate-400">
          ...
          material hosted on these external servers. Therefore, Alfamovies is
          not liable for any content accessed through these third-party links,
        ...
        <p className="mb-4 mt-1 text-base text-slate-400">
          ...
          copyright infringement, hacking, or distribution of malicious
          software. Users are responsible for maintaining the confidentiality of
          their account information and agree to take sole responsibility for
          any activities or content associated with their account.
        </p>
        ...
        <p className="mb-4 mt-1 text-base text-slate-400">
          ...
          third parties for marketing purposes. Please refer to our Privacy
          Policy for more details on how we handle and protect your data.
        </p>

        <p className="mb-4 mt-1 text-base text-slate-400">
          These Terms of Service may be updated periodically, and continued use
          of Alfamovies constitutes acceptance of any changes...
        </p>
        ...
        <p className="mb-4 mt-1 text-base text-slate-400">
          These Terms of Service may be updated periodically, and continued use
          of Alfamovies constitutes acceptance of any changes. It is recommended
          to review these terms regularly. If you have any questions or concerns
